...
export function Hero() {
  return (
    <section className="hero" aria-labelledby="hero-title">
      <Image src="/images/hero-campaign-branded.webp" alt="Dos modelos con prendas negras y logos ON MY OWN frente a una pared de concreto" fill priority sizes="100vw" className="hero-image" />
